...
/**
 * Transport decorator that removes ErrorDetailsStamp before sending.
 *
 * Prevents "Invalid AMQP data" and "table too large for buffer" errors
 * caused by ErrorDetailsStamp accumulating large stacktraces on retries.
 */
